...
(vgl. Auto-Vervollständigung am Handy)
\item Buzzwords:\\
...
Und am Ende installiert die Firma es doch, weil es cool und futuristisch wirkt.
...
\begin{frame}
\frametitle{Verantwortungsdilemma (1979)}
...
\begin{frame}
\frametitle{Alles Schlecht?}

\begin{minipage}{0.5\textwidth}
\large
All dies soll kein Angriff auf die Technologie allgemein darstellen!
\bigskip

Es gibt Bereiche, in denen LLMs und andere intelligente Systeme gut untergebracht sind und echtes Potential bieten: auch im sonst risikobehafteten medizinischen Bereich!
\end{minipage}%
\begin{minipage}{0.5\textwidth}
\vfill
\begin{center}
\includegraphics[width=0.9\textwidth]{images/skin_cancer_paper} 
\end{center}
\vfill
\end{minipage}%
\end{frame}
...
\begin{frame}
\frametitle{Vorsicht geboten!}

\begin{minipage}{0.5\textwidth}
\large
Aber auch unter optimalen Bedingungen dürfen wir nicht vergessen, dass KI ein 
\emph{Werkzeug} ist, das von uns Menschen eingesetzt und geführt wird.
\bigskip

Wir dürfen nicht zu viel Verantwortung und Aufmerksamkeit an die KI abgeben, oder wir laufen Gefahr, dass wir nicht rechtzeitig merken, wenn Dinge schief laufen.
\pause
\end{minipage}%
\begin{minipage}{0.5\textwidth}
\vfill
\begin{center}
\includegraphics[width=0.8\textwidth]{images/skin_cancer} 
\end{center}
\vfill
\end{minipage}%
\end{frame}
...
\item Es wird oft von Menschen überschätzt (vielleicht auch in deiner Firma?).\pause
...
\item tante: ``“AI” as support systems (for diagnostics)'' \url{https://tante.cc/2024/04/22/ai-as-support-systems-for-diagnostics/}
...
\item Nicole Wheeler: ``Publication Bias is Shaping our Perceptions of AI'': \url{https://towardsdatascience.com/is-the-medias-reluctance-to-admit-ai-s-weaknesses-putting-us-at-risk-c355728e9028}
\item Brian Christian: ``When AI flags the ruler, not the tumor — and other arguments for abolishing the black box'' \url{https://venturebeat.com/business/when-ai-flags-the-ruler-not-the-tumor-and-other-arguments-for-abolishing-the-black-box-vb-live/}
\end{itemize}
\end{frame}
\end{document}
