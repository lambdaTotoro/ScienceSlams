...
\texttt{@lambdaTotoro(@chaos.social)} / \texttt{@jbetzend}
\end{center}
\end{frame}
...
\begin{frame}
\begin{center}
\includegraphics[width=.95\textwidth]{images/perceptron} 
\end{center}
\end{frame}
...
\begin{frame}
\frametitle{Andere Kulturen, andere Sitten}
\begin{center}
\includegraphics[scale=1.5]{images/morals.png} 
\end{center}
\end{frame}

\begin{frame}
\frametitle{Umfahren vs. Umfahren}
\begin{center}
\includegraphics[scale=1.65]{images/sparing} 
\end{center}
\end{frame}
