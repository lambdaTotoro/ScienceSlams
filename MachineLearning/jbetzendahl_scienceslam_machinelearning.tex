...
\begin{itemize}
\color{Green4}
\item Roboterapokalypse: Erstmal unwahrscheinlich
\item Maschinelles Lernen kann uns das Leben sehr vereinfachen
\end{itemize}
\bigskip
...
\begin{itemize}
\color{Firebrick1}
\item Maschinelles Lernen ist nicht fehlerfrei
\item Meist nur ein Ergebnis, keine Begründung
\item Vorsicht vor Vorurteilen in der Datengrundlage
\item Kritische Entscheidungen brauchen Menschen in der Schleife
\end{itemize}
